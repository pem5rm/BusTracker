...
route_alias = {
    ...
    'Northline' : 'Northline', "north I'm" : 'Northline',
    'Inner U-Loop' : 'Inner U-Loop', 'N are you' : 'Inner U-Loop', 'N are' : 'Inner U-Loop', 'in you Uber' : 'Inner U-Loop', 'in are you lyft' :  'Inner U-Loop', 'enter you loop' : 'Inner U-Loop', 'in are you live' : 'Inner U-Loop',
...
def get_estimate(routeName, stopName, direction="forward"):
    ...
    try:
        try:
            bestStop = stopToId[stop_alias[(difflib.get_close_matches(stopName, stops, cutoff=0.05))[0]]]
            print(bestStop)
            bestRoute = routeToId[route_alias[(difflib.get_close_matches(routeName, routes, cutoff=0.05))[0]]]
            print(bestRoute)
        except:
